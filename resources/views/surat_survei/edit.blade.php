...
<form action="{{ route('surat_survei.update', $surat_survei->id) }}" method="post" enctype="multipart/form-data">
    {{ csrf_field() }}
    {{ method_field('put') }}
    <div class="row">
        <div class="col-md-12 d-flex align-items-stretch grid-margin">
            <div class="row flex-grow">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Edit Data - <b>{{$surat_survei->judul_surat}}</b> </h4>
                                ...
                                <div class="form-group{{ $errors->has('judul_surat') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        <input id="judul_surat" type="text" class="form-control" name="judul_surat" placeholder="Judul"
                                            value="{{ $surat_survei->judul_surat }}" required>
