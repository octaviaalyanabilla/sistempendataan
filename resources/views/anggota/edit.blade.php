                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group{{ $errors->has('nip') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="nip" type="number" class="form-control" name="nip" placeholder="NIP"
                                        value="{{ $data->nip }}" maxlength="8" required>
                                    @if ($errors->has('nip'))
                                    <span class="help-block">
                            ...
                            <div class="form-group{{ $errors->has('tgl_lahir') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="tgl_lahir" type="date" class="form-control" name="tgl_lahir" placeholder="Tanggal Lahir"
                                ...
                                <div class="col-md-6">
                                    <select class="form-control" name="user_id" required="">
                                        ...
                                        <option value="{{$user->id}}"
                                            {{$data->user_id === $user->id ? "selected" : ""}}>{{$user->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
