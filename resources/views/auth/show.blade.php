                        ...
                        <div class="form-group{{ $errors->has('level') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" name="level" required="" readonly>
                                    <option value="admin" @if($data->level == 'admin (tim pendataan)') selected @endif>Admin</option>
                                    <option value="kepala bidang um" @if($data->level == 'kepala bidang um') selected @endif>Kepala Bidang Um</option>
                                    <option value="kepala dinas" @if($data->level == 'kepala dinas') selected @endif>Kepala Dinas</option>
                                </select>
                            </div>
                        </div>
                        @endif
